...
“近30天发单”和“近30天发单额”使用滚动时间窗口，从当前时间向前计算 30 个自然日内符合展示规则的任务，不使用自然月口径。

如果后台配置了官方锚点数据，例如官方累计发单、官方近30天发单、官方近30天发单额，则统计应按“官方锚点 + 锚点之后新增的符合展示规则任务”计算。不要把锚点之前已经包含在官方数据里的历史任务再次叠加，避免因展示规则变化造成重复统计。

近30天锚点只在锚点时间仍处于当前近30天窗口内时有效。锚点时间早于当前近30天窗口后，如果没有新的官方锚点，近30天发单和近30天发单额应从当前近30天窗口内符合展示规则的任务重新计算，不能继续沿用过期基数。
